...
tiles = [dirt_tile_S, grass_tile_S, rock_tile_S]
...
class Minimap:
    ...
    def draw(self, sc, x, y, id_loc, global_loc_map, loc_map):
        if not global_loc_map[id_loc].is_on_map:
            ...
            pygame.draw.rect(sc, [0, 0, 0], (32 * tile_w * x, 24 * tile_h * y, 32 * tile_w, 24 * tile_h), 2)

            if global_loc_map[id_loc].l_n != -1:
                self.draw(sc, x - 1, y, global_loc_map[id_loc].l_n, global_loc_map, global_loc_map[global_loc_map[id_loc].l_n].location_matrix)
            if global_loc_map[id_loc].r_n != -1:
                self.draw(sc, x + 1, y, global_loc_map[id_loc].r_n, global_loc_map, global_loc_map[global_loc_map[id_loc].r_n].location_matrix)
            if global_loc_map[id_loc].u_n != -1:
                self.draw(sc, x, y - 1, global_loc_map[id_loc].u_n, global_loc_map, global_loc_map[global_loc_map[id_loc].u_n].location_matrix)
            if global_loc_map[id_loc].d_n != -1:
                self.draw(sc, x, y + 1, global_loc_map[id_loc].d_n, global_loc_map, global_loc_map[global_loc_map[id_loc].d_n].location_matrix)
